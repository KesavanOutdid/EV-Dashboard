...
const HardwareManagement = ({ userInfo, handleLogout }) => {
                            ...
                            <div className="col-md-12 grid-margin">
                                <div className="row">
                                    <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                                        <h3 className="font-weight-bold">Hardware Management</h3>
                                        <p className="font-weight">Manage EV Charger's, assign rates set charger's private/public mode. </p>
                                    </div>
